  ...
  return (
    ...
    >
      ...
      <div className="w-[80%] md:w-[50%] space-y-4 flex flex-col items-center justify-center md:items-start text-center md:text-start py-10 md:py-0">
        <h1 className="text-[orangered]">A Short Introduction</h1>
        <p>
          I am a versatile web developer with expertise in React.js and a
          growing proficiency in Next.js and React Native. In addition to my
